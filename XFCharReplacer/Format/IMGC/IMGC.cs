...
using System.IO;
using System.Linq;
using XFCharReplacer.Image;
using XFCharReplacer.Compression;
using XFCharReplacer.IO;

namespace XFCharReplacer.Format
{
    public class IMGC
    {
        public Bitmap Image;
        ...
        public IMGC(Stream input)
        {
            using (var br = new BinaryReaderX(input, true))
            {
                ...
                Image = XFCharReplacer.Image.Common.Load(pic, settings);
            }
        }
        ...
        public void Save(Stream file)
        {
            ...
            byte[] pic = XFCharReplacer.Image.Common.Save(Image, settings);
